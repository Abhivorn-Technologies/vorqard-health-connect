...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Get in touch with Vorqard. We'd love to hear from you about partnerships, demos, or support." },
      { property: "og:title", content: "Contact Us — Vorqard" },
      { property: "og:description", content: "Get in touch with Vorqard for partnerships, demos, or support." },
    ],
  }),
