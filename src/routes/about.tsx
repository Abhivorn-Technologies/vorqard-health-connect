...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About Vorqard — Our Mission in Digital Health" },
      { name: "description", content: "Learn about Vorqard's mission to transform healthcare with digital health identities and QR-based medical records." },
      { property: "og:title", content: "About Vorqard — Our Mission in Digital Health" },
      { property: "og:description", content: "Learn about Vorqard's mission to transform healthcare with digital health identities." },
    ],
  }),
  component: AboutPage,
});
